...
import { api as ENV_API } from '../../../environments/environment'; // ../../../environments/environment
import { UNAUTHORIZED } from '../../constants/http'
import { TOKEN_HEADER } from '../../constants/auth';
...
export class HttpRequesterService{
  ...
  // 请求包装器
  private handleRequest<T>(request: any): Promise<IResponseData<T>> {
